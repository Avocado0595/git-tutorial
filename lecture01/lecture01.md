...
![vsc terminal](/lecture01/cmd1.png)

  

gõ vào ô đường dẫn ```cmd``` (hoặc ```powershell```), xong enter:

![vsc terminal](/lecture01/cmd2.png)
...
![vsc terminal](/lecture01/cmd3.png)
...
Sau khi add thì mình còn 1 bước nữa (tạm gọi là xác nhận những thay đổi này) với lệnh: ```git commit -m “<ghi chú nội dung>” ```
...
Sau khi đăng nhập thành công, chúng ta cùng tạo 1 repository (*từ này dịch tiếng việt nghĩa là kho - ý là cái kho để lưu và quản lý code cho chúng ta ấy :3*). Click nút New:
...
Ở đây, chúng ta sẽ thấy hướng dẫn để push (đẩy code) từ git local ban đầu lên git remote trên github. (có 1 hướng dẫn phía trên là tạo mới nữa, nhưng do chúng ta đã tạo ban đầu rồi thì không cần tạo nữa)
